...
We as members, contributors, and leaders of the Emergi Foundation
open-source community pledge to make participation a harassment-free
...
status, nationality, personal appearance, race, caste, colour,
...
* Accepting responsibility and apologising to those affected by
...
fair corrective action in response to any behaviour that they deem
...
behaviour may be reported to the community leaders responsible for
enforcement at `conduct@emrgi.org`. All complaints will be
reviewed and investigated promptly and fairly.

All community leaders are obligated to respect the privacy and
security of the reporter of any incident. Enforcement is by an
independent committee of at least three community members from at
least two organisations, kept separate from any single package's
maintainers.
...
1. **Correction** — Private, written warning from community
   leaders, providing clarity around the nature of the violation
   and an explanation of why the behaviour was inappropriate.
2. **Warning** — A warning with consequences for continued
   behaviour, including no interaction with the people involved
   for a specified period of time.
3. **Temporary ban** — A temporary ban from any sort of
...
FAQ at <https://www.contributor-covenant.org/faq>.
